...
function Food({ setOrder, setInfor }) {
  const food = [
    ...
    {
      img: "https://media.travelmag.vn/files/thanhhuyen/2020/11/26/75429326_2504816359788483_4511967576577802240_o-1651.jpg",
            ...
            {food.map((item, index) => (
              <div key={index} className="food__pro">
                <div className="food__wrap">
                  <div className="hello">
                    <div href="" className="food__content">
                      <div className="food__tym">
                        <FontAwesomeIcon
                          className="food__icon-tym"
                          icon={faHeart}
                        />
                      </div>
                      <div className="food__eye">
                        <FontAwesomeIcon
                          className="food__icon-eye"
                          icon={faEye}
                        />
                      </div>
                      <div className="food__ang">
                        <img src={item.img} alt="" className="food__img" />
                      ...
                      <div className="food__con">
                        ...
                        <div className="food__title">{item.title}</div>
                        <div className="food__cart">
                          ...
                          <span className="food__price">${item.price}</span>
                        </div>
                      </div>
                    </div>
                  </div>
